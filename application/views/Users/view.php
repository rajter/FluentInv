                    ...
                    <div class="col-md-12">
                        ...
                        <!-- Add the bg color to the header using any of the bg-* classes -->
                            <div class="widget-user-header bg-aqua-active">
                                <h2><i class="fa fa-tag"></i> <?php echo $user->name; ?></h2>
                                <h5 class="widget-user-desc"><?php echo $user->surname; ?></h5>
                            </div>
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right" style="margin-top: 15px;">
                                    <a class="btn btn-primary" href=<?php echo base_url(). "index.php/users/edit/". $user->id; ?>><i class="fa fa-edit"></i> Uredi</a>
                                </div>
                            </div>
                            <div class="box-body">
                                <style>
