...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Međuskladišnice</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        <a href=<?php echo current_url().'/newTransfer' ?> class="btn btn-primary"><i class="fa fa-plus"></i> Nova Međuskladišnica</a>
                    </div>
                    <div class="box-body">
                        <div class="col-md-12">
                            <table id="transfers_table" class="table table-bordered table-hover table-striped" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fa fa-sign-out"></i> Iz Lokacije</th>
                                        <th><i class="fa fa-sign-in"></i> U Lokaciju</th>
                                ...
                                <tbody>
                                    <?php foreach ($query as $trans): ?>
                                        <tr id=<?php echo "transfer-row-".$trans->transaction_number; ?>>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-xs">
                                                    <a href=<?php echo current_url().'/view/'.$trans->transaction_number; ?> data-toggle="modal"
                                                        ...
                                                        <button type="button" class="btn btn-danger transfer_modal_delete" data=<?php echo $trans->transaction_number; ?>>
