            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-edit"></i> Polog <?php echo $deposit[0]->transaction_number; ?></h3>
                    </div>
                    <div class="box-body">
                        <!-- <?php echo var_dump($depositData); ?>
                        <?php echo var_dump($deposit); ?>
                        <?php echo var_dump($query); ?> -->

                        <?php echo form_open('deposits/Update'); ?>
                            <input class="hidden" type="text" name="transaction_id" value=<?php echo $deposit[0]->trans_id; ?>>
                            <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    value=<?php echo $deposit[0]->date; ?>>
                                                </div>
                                                <!-- /.input group -->
                                            </div>

                                            <div class="form-group">
                                                <label>Lokacija:</label><p class="hidden" id="current-location"><?php echo $deposit[0]->location_id; ?></p>
                            ...
                            <div class="row">
                                <div class="col col-xs-12">
                                                ...
                                                <tr id=<?php echo "row-".$item->id; ?>>
                                                    ...
                                                    <td class="item_quantity">
                                                        ...
                                                        <div class="btn-group btn-group-sm pull-right" role="group" aria-label="..." style="margin:0px;">
                                                            ...
                                                            <button type="button" class="btn btn-primary btn-qnt" id=<?php echo $item->id; ?>><i class="fa fa-calculator"></i> </button>
                                                        </div>
                                                    </td>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="footnote" placeholder="Tekst Napomene"><?php echo $deposit[0]->footnote; ?></textarea>
                                        <textarea id="hidden-footnote" name="footnote" rows="8" cols="40" class="hidden"><?php echo $deposit[0]->footnote; ?></textarea>
                                    </div>
                                </div>
