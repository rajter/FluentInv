...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-database"></i> Polozi - <?php echo $location->name; ?>
            <small><?php echo $location->address." ".$location->zipcode." ".$location->city." ".$location->country; ?></small>
        </h1>
        <ol class="breadcrumb">
                                        ...
                                        <tr id=<?php echo "receipt-row-".$trans->transaction_number; ?>>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-xs">
                                                    <a href=<?php echo base_url().'index.php/Deposits/view/'.$trans->transaction_number; ?> data-toggle="modal"
                                                        type="button" class="btn btn-info"><i class="fa fa-search"></i> Pregled</a>
                                                    <a href=<?php echo base_url().'index.php/Deposits/edit/'.$trans->transaction_number; ?> type="button" class="btn btn-primary"><i class="fa fa-edit"></i> Uredi</a>
