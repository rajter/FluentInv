...
class Employees extends My_Controller {
    ...
    function __construct()
     {
       ...
       $this->load->model(array('employee', 'user'));
     }
    ...
    public function index()
    {
        ...
        $data['query'] = $this->employee->getAll($session_data['id']);
    ...
    public function view($id)
    {
        ...
        $viewData['employee'] = $this->employee->get($id);

        $this->load_views($headerscripts, $footerscripts, $data, $viewData, 'Employees/view');
    }
}
