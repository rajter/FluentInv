...
$(document).ready(function() {
    ...
    */
    ...
    //-----------------------------------
    //  Dialog za upis količine
    //-----------------------------------
    $('#selected_items_table_body').on('click', '.btn-qnt', function()
    {
        id = $(this).attr("id");
        ...
        $('#selected_items_table_body').append('<tr id=row-'+ item_id + '><td>'+ item_id +'</td>' +
            ...
            '<td class="item_quantity">' +
                ...
                '<div class="btn-group btn-group-sm pull-right" role="group" aria-label="..." style="margin:0px;">' +
                    ...
                    '<button type="button" class="btn btn-primary btn-qnt" id='+ item_id +'><i class="fa fa-calculator"></i> </button>' +
                '</div>' +
            '</td>' +
            '<td>'+ item_name +'</td>' +
